package com.infora.admin.config;
...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.infora.admin.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.infora.admin.security.DomainUserDetailsService", "createSpringSecurityUser");
